    ...
    <div className="px-6 py-4 flex flex-col gap-5">
      <div className="flex md:flex-row md:justify-between md:items-center">
        ...
        <div className="flex gap-4">
          ...
          //remove purchase condition to be free and show mark as completed
          {!purchase ? (
      ...
      {/* remove is Locked to be completely free */}
      {isLocked ? (
        <div className="px-10 flex flex-col gap-5 items-center bg-[#FFF8EB] py-4">
