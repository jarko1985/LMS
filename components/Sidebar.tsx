    ...
    <div className="max-sm:hidden flex flex-col w-64 border-r shadow-md px-3 my-4 gap-4 text-sm font-medium">
      {sidebarRoutes.map((route) => (
        <Link
          href={route.path}
          key={route.path}
          className={`flex items-center gap-4 p-3 text-[#07153b] rounded-lg hover:bg-[#FFF8EB] transition-all hover:translate-x-2 duration-150
          ${pathname.startsWith(route.path) && "bg-[#ec3b3b] hover:bg-[#ec3b3b]/80"}
          `}
        >
